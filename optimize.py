...
def main(use_subset=False):
    # Initialize WandB
    wandb.init(project="optimize_project", entity="seoku", config={
    ...
    train_loader = get_train_loader('data/train', batch_size, subset=subset)
    val_loader = get_validation_loader('data/valid', batch_size, subset=subset)
